Get-Member                                                #Gets member, properties, methods
...
Get-Help -Name Get-Command -Online                        # Get help for specific command online with examples
Get-Help -Name Get-Command -Full                          # Get complete help document for the specified command
Get-Help -Name Get-Command -Examples                      # Get the example about syntax etc for specifies command
Get-Help -Name Get-Command -Detailed 

Get-InstalledModule                                       # Gets The list of installed modules
...
$a = 2
$b = 'a is $a'                                            # using single quotes '' wont be resolving the value of $a
$b
output -> a is $a

$a = 2
$b = "a is $a"                                            # using double quotes "" will resolve the value of $a
$b
output -> a is 2 

$a -eq 0                                                  # Equality comparison operator
$a -ceq 0                                                 # case wquality comparison operator
...
# Cmdlet Basics
###################################################
#=> cmdlet commands have two parts verb+noun
###################################################
dir                                                       # get the list of files and folders
dir -Path "C:\Users" -Recurse -Hidden                     # see hidden files and folders in resursive mode
...
Get-Alias dir                                             # Get the aliase for a specific command
Set-Aliase -Name ls -Value Get-ChildItem                  # set alias for specific command
